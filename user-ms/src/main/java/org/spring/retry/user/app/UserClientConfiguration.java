...
public class UserClientConfiguration {
    ...
    private static final String CONNECTION_TIMEOUT_MILLIS = "${client.feign.connection-timeout-millis}";
    private static final String READ_TIMEOUT_MILLIS = "${client.feign.read-timeout-millis}";
    private static final String RETRY_PERIOD_MILLIS = "${client.feign.retry.period-millis}";
    private static final String RETRY_MAX_PERIOD_MILLIS = "${client.feign.retry.max-period-millis}";
    private static final String RETRY_MAX_ATTEMPTS = "${client.feign.retry.attempts}";
